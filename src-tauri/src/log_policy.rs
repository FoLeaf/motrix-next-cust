...
pub(crate) const MOTRIX_OPT_LOG_FILE: &str = "motrix-next-opt.log";
pub(crate) const ARIA2_LOG_FILE: &str = "aria2-next.log";

pub(crate) fn is_managed_active_log_file(name: &str) -> bool {
    matches!(name, MOTRIX_LOG_FILE | MOTRIX_OPT_LOG_FILE | ARIA2_LOG_FILE)
}
...
pub(crate) fn is_legacy_log_file(name: &str) -> bool {
    ...
    aria2_native
        ...
        || has_numeric_suffix(name, "motrix-next-opt.log.")
}
